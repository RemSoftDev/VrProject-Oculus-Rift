...
{
    public class CreateExcelFileHelper
    {
        public static bool CreateExcelDocument(List<StatisticItem> listStatistic, string xlsxFilePath)
        {
            try
            {
                DataSet ds = new DataSet();
                ds.Tables.Add(ListToDataTable(listStatistic));
                bool res = CreateExcelDocument(ds, xlsxFilePath);
                return res;
            }
            catch (Exception ex)
            {
        ...
        public static DataTable ListToDataTable<T>(List<T> list)
        {
            try
            {
                ...
                {
                    res.Columns.Add(new DataColumn(info.Name, GetNullableType(info.PropertyType)));
                }
        ...
        public static bool CreateExcelDocument(DataSet ds, string excelFilename)
        {
            ...
            catch (Exception ex)
            {
                ...
                App.SendException(ex);
                App.SendMessage("Failed, exception thrown: " + ex.Message);
            return false;
            }
        }
